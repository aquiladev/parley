// EIP-712 helpers for the on-chain Deal. Match Settlement.sol's typehash
// exactly — verified by Foundry test `test_dealHash_matchesOffchainDigest`.
// Mirrors packages/mm-agent/src/eip712.ts; consolidate post-Phase-2.
